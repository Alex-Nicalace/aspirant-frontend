...
const faceScientificPublReducer = (state, action) => {
    if (state === undefined) {
        return {
            dataset: [],
    ...
    switch (action.type) {
        case FETCH_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
        ...
        case REQUEST_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
                ...state,
                isLoading: true
            }
        case FAILURE_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
                ...state,
                error: action.payload,
                isLoading: false,
            }
        case INS_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
                ...state,
        ...
        case DEL_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
                ...state,
        ...
        case UPD_FACE_SCIENTIFIC_PUBL_ACTION:
            return {
                ...state,
...
export default faceScientificPublReducer;