...
const faceAcademicAdvisorReducer = (state, action) => {
    ...
    switch (action.type) {
        case FETCH_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
        ...
        case REQUEST_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
                ...state,
                isLoading: true
            }
        case FAILURE_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
                ...state,
                error: action.payload,
                isLoading: false,
            }
        case INS_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
                ...state,
        ...
        case DEL_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
                ...state,
        ...
        case UPD_FACE_ACADEMIC_ADVISOR_ACTION:
            return {
                ...state,
